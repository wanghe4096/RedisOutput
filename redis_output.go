...
func (self *RedisOutput) Init(config interface{}) (err error) {
	return
}

func (self *RedisOutput) Run(or OutputRunner, h PluginHelper) (err error) {
	if or.Encoder() == nil {
...
func init() {
	RegisterPlugin("RedisOutput", func() interface{} {
